...
def generate_launch_description():
    ...
    world_file_name = 'turtlebot3_controlraces/' + TURTLEBOT3_MODEL + '.model'
    world = os.path.join(get_package_share_directory('turtlebot3_gazebo2'), 'worlds', world_file_name)
